...
\dplot{stretchMarm}{stretchMarm_strip}{To generate a slowly varying laterally model we first stretch Marmousi laterally and then replicate it. (a) Full model. (b) Crop of similar to the original marmousi size}
% 
