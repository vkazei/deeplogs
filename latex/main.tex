...
\fplot{T_data}{T_scaled}{train_singleCMP_predicted}{train_multiCMP_predicted}{(a) Velocity logs prepared for training and (b) scaled version for the CNN input. (c) Trained prediction from single CMP data, (d) from multi CMP data}
...
\dplot{X_muted}{X_scaled}{(a) raw CMP gather, (b) scaled version of the same CMP gather. We utilize only positive offset as the data are synthetic and due to the reciprocity there is no difference with swaping source and receiver positions.}
...
\twplot{in_out_shape}{net_multiCMP}{(a)Shape of input and target data. (b) Neural net architecture}
...
\fplot{test_singleCMP_marmvel1D_true}{test_singleCMP_marmvel1D_inverted}{test_multiCMP_marmvel1D_inverted}{test_multiCMP_marmvel1D_X_scaled}{(a)Test model, (b) scaled data, (c)inversion with single CMP input, (d) inversion with multi CMP input}
...
\fplot{test_singleCMP_marmvel1D_distort_true}{test_singleCMP_marmvel1D_distort_inverted}{test_multiCMP_marmvel1D_distort_inverted}{test_multiCMP_marmvel1D_distort_X_scaled}{(a)Test model, (b) scaled data, (c)inversion with single CMP input, (d) inversion with multi CMP input}
...
\fplot{test_singleCMP_overthrust1D_true}{test_singleCMP_overthrust1D_inverted}{test_multiCMP_overthrust1D_inverted}{test_multiCMP_overthrust1D_X_scaled}{(a)Test model, (b) scaled data, (c)inversion with single CMP input, (d) inversion with multi CMP input}

\subsection{Tests on known synthetic models}

\paragraph{Marmousi}
\fplot{test_singleCMP_marmvel_true}{test_singleCMP_marmvel_inverted}{test_multiCMP_marmvel_inverted}{test_multiCMP_marmvel_X_scaled}{(a)Test model, (b) scaled data, (c)inversion with single CMP input, (d) inversion with multi CMP input}

\paragraph{SEAM}
\fplot{test_singleCMP_seam100_true}{test_singleCMP_seam100_inverted}{test_multiCMP_seam100_inverted}{test_multiCMP_seam100_X_scaled}{(a)Test model, (b) scaled data, (c)inversion with single CMP input, (d) inversion with multi CMP input}

\paragraph{Overthrust}
\fplot{test_singleCMP_overthrust2D_true}{test_singleCMP_overthrust2D_inverted}{test_multiCMP_overthrust2D_inverted}{test_multiCMP_overthrust2D_X_scaled}{(a)Test model, (b) scaled data, (c)inversion with single CMP input, (d) inversion with multi CMP input}
